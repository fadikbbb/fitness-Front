...
export function EditTrainer({ id, currentData, setError }) {
  const [isOpen, setIsOpen] = useState(false);
  const { updateTrainer, loading, error } = useUpdateContent(
    setError
  );
  ...
  const handleEditTrainer = async (data) => {
    await updateTrainer(data, id);
        ...
        >
          ...
          >
            ...
            <form
              ...
              onSubmit={handleSubmit(handleEditTrainer)}
            >
              {/* Image field */}
              <div className="mb-4">
