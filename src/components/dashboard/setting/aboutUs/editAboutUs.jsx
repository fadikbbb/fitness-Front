...
export function EditAboutUs({ id, currentData, setError }) {
  ...
  const handleEditAboutUs = async (data) => {
    await updateAbout(data, id);
    ...
    <div>
      ...
      {isOpen && (
        ...
        >
          ...
          >
            <h1 className="text-xl font-semibold mb-4">Edit AboutUs</h1>

            {/* Form */}
            <form
              encType="multipart/form-data"
              onSubmit={handleSubmit(handleEditAboutUs)}
            >
              {/* Image field */}
              <div className="mb-4">
